...
namespace Tremor.Buffs
{
	public class LivingTombstoneBuff : ModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex)
		{
			...
			{
				Projectile.NewProjectile(player.position.X + player.width / 2, player.position.Y + player.height / 2, 0f, 0f, ModContent.ProjectileType<Projectiles.LivingTombstonePro>(), 0, 0f, player.whoAmI, 0f, 0f);
			}
		}
	}
}