...
namespace Tremor.Buffs
{
	public class VortexBeeBuff:TremorModBuff
	{
		...
		public override void Update(Player player, ref int buffIndex)
		{
			...
			{
				Projectile.NewProjectile(null, player.position.X + player.width / 2, player.position.Y + player.height / 2, 0f, 0f, ModContent.ProjectileType<VortexBee>(), 0, 0f, player.whoAmI, 0f, 0f);
			}
		}
	}
}