...
{
	public class MagiumRod:TremorModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			for (int num147 = 0; num147 < num146; num147++)
			{
				...
				float x4 = vector2.X;
				float y4 = vector2.Y;
				Projectile.NewProjectile(null, x4, y4, num148, num149, ModContent.ProjectileType<Projectiles.MagiumRodPro>(), num73, num74, i, 0f, 0f);
			}
			return false;
		}
