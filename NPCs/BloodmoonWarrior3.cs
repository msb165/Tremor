	...
	public class BloodmoonWarrior3:TremorModNPC
	{
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("BloodmoonWarrior3Gore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("BloodmoonWarrior3Gore2"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("UndeadGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("UndeadGore2"), 1f);
			}
		}
