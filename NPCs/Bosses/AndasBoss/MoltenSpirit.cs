...
{
	public class MoltenSpirit:TremorModNPC
	{
		...
		public override bool PreAI()
		{
			...
			{
				float num867 = 6f;
				int num869 = ModContent.ProjectileType<SpiritFire>();
				...
				Projectile.NewProjectile(null, vector86.X, vector86.Y, num864, num865, num869, npc.damage, 0f, Main.myPlayer, 0f, 0f);
			}
			return false;
		}
