...
{
	public class CogLordArmSecond:TremorModNPC
	{
		...
		public override void AI()
		{
			...
			if ((Main.npc[(int)npc.ai[0]].type == ModContent.NPCType<CogLordGun>() || Main.npc[(int)npc.ai[0]].type == ModContent.NPCType<CogLordHand>()) && Main.npc[(int)npc.ai[0]].active)
			{
