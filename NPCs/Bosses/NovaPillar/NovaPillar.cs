...
namespace Tremor.NPCs.Bosses.NovaPillar
{
	...
	public class NovaPillar : ModNPC
	{
		...
		public override void AI()
		{
			...
			{
				Dust dust21 = Main.dust[Dust.NewDust(npc.Left, npc.width, npc.height / 2, 241)];
			...
			for (int num1940 = 0; num1940 < 3; num1940++)
			{
				if (Main.rand.NextBool(5))
				{
					Dust dust22 = Main.dust[Dust.NewDust(npc.Top + new Vector2(-npc.width * (0.33f - 0.11f * num1940), -20f), (int)(npc.width * (0.66f - 0.22f * num1940)), 20, 135)];
			...
			if (npc.ai[2] == 1f)
			{
				...
				if (npc.ai[1] < 150f)
				{
					for (int num1362 = 0; num1362 < 3; num1362++)
					{
						...
						{
							Dust dust5 = Main.dust[Dust.NewDust(npc.Top + new Vector2(-npc.width * (0.33f - 0.11f * num1362), -20f), (int)(npc.width * (0.66f - 0.22f * num1362)), 20, dustID)];
							dust5.velocity.X = 0f;
