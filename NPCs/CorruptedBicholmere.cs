	...
	public class CorruptedBicholmere:TremorModNPC
	{
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("CorruptedBihcolmereGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("CorruptedBicholmereGore2"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("CorruptedBicholmereGore3"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("CorruptedBicholmereGore3"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("CorruptedBicholmereGore3"), 1f);
			}
		}
