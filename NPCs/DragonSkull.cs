...
namespace Tremor.NPCs
{
	...
	public class DragonSkull:TremorModNPC
	{
		...
		public override void NPCLoot()
		{
			if (Main.rand.NextBool())
				npc.NewItem(ModContent.ItemType<DragonBreath>(), Main.rand.Next(30, 40));
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("DragonSkullGore"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("DragonSkullGore2"), 1f);
			}
			else
			{
