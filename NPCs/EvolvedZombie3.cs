...
{
	public class EvolvedZombie3:TremorModNPC
	{
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			...
			{
				for (int k = 0; k < 20; k++)
					Dust.NewDust(npc.position, npc.width, npc.height, 226, 2.5f * hit.HitDirection, -2.5f, 0, default(Color), 1f);
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("EvolvGore2"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("EvolvGore3"), 1f);
