...
{
	public class Shnoot:TremorModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			// Banner = npc.type;
			// Todo: BannerItem = ModContent.ItemType<ShnootBanner>();
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("ShnootGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("ShnootGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("ShnootGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("ShnootGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("ShnootGore2"), 1f);
			}
			else
			{
