...
namespace Tremor.NPCs
{
	...
	public class SoulofTrust:TremorModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			bossBag = ModContent.ItemType<TrinityBag2>();
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("TrustGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("TrustGore2"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("TrustGore3"), 1f);
