...
{
	public class TikiSoul:TremorModNPC
	{
		...
		public override bool PreAI()
		{
			...
			if (--TimeToShoot <= 0)
			{
				...
				//int k = Projectile.NewProjectile(null, npc.Center.X, npc.Center.Y, Velocity.X, Velocity.Y, ModContent.ProjectileType<Projectiles.TikiSoulPro>(), 0, 1f);
