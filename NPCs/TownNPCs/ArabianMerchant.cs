...
namespace Tremor.NPCs.TownNPCs
{
	...
	public class ArabianMerchant:TremorModNPC
	{
		...
		{
			shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<GenieLamp>());
			shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<JavaHood>());
			shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<JavaRobe>());
			shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<SandstoneRing>());

			if (NPC.downedBoss1)
			{
				shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<FossilSugar>());
				shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<DesertCrown>());
			}
			if (NPC.downedBoss2)
			{
			...
			if (Main.hardMode)
				shop.AddUniqueItem(ref nextSlot, ModContent.ItemType<DesertEagle>());
		}
