...
{
	public class DivineClaymorePro:TremorModProjectile
	{
		...
		public override void AI()
		{
			...
			if ((int)projectile.ai[1] % 3 == 0 && projectile.owner == Main.myPlayer)
			{
				...
				Projectile.NewProjectile(null, projectile.Center.X, projectile.Center.Y, vector64.X, vector64.Y, ModContent.ProjectileType<Projectiles.DivineRingPro>(), projectile.damage / 4, projectile.knockBack, projectile.owner, -10f, 0f);
			}
		}
