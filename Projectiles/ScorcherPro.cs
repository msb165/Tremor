...
{
	public class ScorcherPro:TremorModProjectile
	{
		...
		public override void AI()
		{
			...
			if (Main.player[projectile.owner].itemAnimation < Main.player[projectile.owner].itemAnimationMax / 3)
			{
				...
				if (projectile.localAI[0] == 0f && Main.myPlayer == projectile.owner)
				{
					...
					{
						Projectile.NewProjectile(null, projectile.Center.X + projectile.velocity.X, projectile.Center.Y + projectile.velocity.Y, projectile.velocity.X * 1.5f, projectile.velocity.Y * 1.5f, ModContent.ProjectileType<Projectiles.ScorcherTwo>(), projectile.damage, projectile.knockBack * 0.85f, projectile.owner, 0f, 0f);
					}
				}
			}
			else
