...
{
	public class WraithWrathPro:TremorModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			if (Main.myPlayer == projectile.owner)
			{
				...
				for (int num161 = 0; num161 < num160; num161++)
				{
					...
					Projectile.NewProjectile(null, projectile.oldPosition.X + projectile.width / 2, projectile.oldPosition.Y + projectile.height / 2, value12.X, value12.Y, ModContent.ProjectileType<Projectiles.WraithCloud>(), (int)(projectile.damage * 0.8), projectile.knockBack * 0.8f, projectile.owner, 0f, 0f);
				}
			}
		}
	}
