...
namespace Tremor.Projectiles
{
	public class ZootalooRodPro : ModProjectile
	{
		...
		{
			Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, 0f, 0f, ModContent.ProjectileType<Projectiles.SporeExplosion>(), projectile.damage, projectile.knockBack, projectile.owner, 0f, 0f);
		}
