...
{
	public class CrimstoneBed:TremorModTile
	{
	...
	AddToArray(ref TileID.Sets.RoomNeeds.CountsAsChair);
		...
		{
			Item.NewItem(null, i * 16, j * 16, 64, 32, ModContent.ItemType<Items.Crimstone.CrimstoneBed>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Crimstone.CrimstoneBed>();
		}
	}
}