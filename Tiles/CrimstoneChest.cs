...
{
	public class CrimstoneChest : TremorModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Crimstone Chest";
				if (player.cursorItemIconText == "Crimstone Chest")
				{
					player.cursorItemIconID = ModContent.ItemType<Items.Crimstone.CrimstoneChest>();
