...
namespace Tremor.Tiles
{
	public class GloomstoneChest:TremorModTile
	{
		...
		public override void MouseOver(int i, int j)
		{
			...
			{
				player.cursorItemIconText = Main.chest[chest].name.Length > 0 ? Main.chest[chest].name : "Gloomstone Chest";
				if (player.cursorItemIconText == "Gloomstone Chest")
				{
					player.cursorItemIconID = ModContent.ItemType<Items.GloomstoneChest>();
