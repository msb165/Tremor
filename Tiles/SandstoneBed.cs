...
{
	public class SandstoneBed:TremorModTile
	{
		...
		{
			Item.NewItem(null, i * 16, j * 16, 64, 32, ModContent.ItemType<Items.Sandstone.SandstoneBed>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Sandstone.SandstoneBed>();
		}
	}
}