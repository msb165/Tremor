...
namespace Tremor
{
	...
	public static class TremorUtils
	{
		...
		/// </summary>
		public static bool HasBuffSafe(this Player player, int buffType)
		{
		...
		/// <summary>
		/// Transforms fullname to a path
		/// </summary>
		public static string FullNameToPath(this Type type)
		...
		/// </summary>
		public static WeightedRandom<T> ToWeightedCollection<T>(this (T obj, double weight)[] entries)
			=> new WeightedRandom<T>(entries.Select(x => new Tuple<T, double>(x.obj, x.weight)).ToArray());
