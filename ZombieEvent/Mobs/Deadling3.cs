...
namespace Tremor.ZombieEvent.Mobs
{
	...
	public class Deadling3:TremorModNPC
	{
		...
		public override void SetDefaults()
		{
			...
			// Banner = npc.type;
			// Todo: BannerItem = ModContent.ItemType<NThreeDeadlingBanner>();
		}
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("DeadlingHead3"), 1f);
