	...
	public class FarmerZombie:TremorModNPC
	{
		...
		public override void HitEffect(NPC.HitInfo hit)
		{
			if (npc.life <= 0)
			{
				...
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("FarmForkGore"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("FarmGore1"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("FarmGore2"), 1f);
				Gore.NewGore(null, npc.position, npc.velocity, Mod.GetGoreSlot("FarmGore2"), 1f);
